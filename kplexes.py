...
parser.add_argument('--k', type=int, help='How many non neighbors a node is allowed to have.')
parser.add_argument('--m', type=int, help='The size of the smallest kplex')
parser.add_argument('--fileName', help='fileName')

args = parser.parse_args()
k_cmd = args.k
m = args.m
fileNameStr = args.fileName
